...
export class MyApp {
  ...
  rootPage: any = OutroEnderecoPage;
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      ...
      { title: 'Pedido concluído', component: PedidoConcluidoPage },
      { title: 'Instrucoes enviadas', component: InstrucoesEnviadasPage},
      { title: 'Sucesso Senha', component: SucessoSenhaPage},
      { title: 'Meus Dados', component: MeusDadosPage},
      { title: 'Outro Endereco', component: OutroEnderecoPage}
    ];
